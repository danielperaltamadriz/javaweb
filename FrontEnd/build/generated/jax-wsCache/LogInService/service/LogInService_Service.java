 ...
 * 
 */
@WebServiceClient(name = "LogInService", targetNamespace = "http://Service/", wsdlLocation = "http://localhost:8080/LoginService/LogInService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/LoginService/LogInService?wsdl");
    ...
    public LogInService getLogInServicePort() {
        return super.getPort(new QName("http://Service/", "LogInServicePort"), LogInService.class);
    }
    ...
    public LogInService getLogInServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Service/", "LogInServicePort"), LogInService.class, features);
    }
